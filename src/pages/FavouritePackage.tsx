...
export const FavouritePackage = () => {
   const [storedData, seatStoredData] = useState(
      ...
      Swal.fire({
         ...
         if (result.isConfirmed) {
            ...
            const deletedData = LSFavouriteData.filter(
               (el: Package) => el.package_name !== name
            );
   ...
   return (
      <div>
         <div className="headerContainer w-[80%] m-[auto] mt-5 flex items-center justify-between">
            <p className="text-xl font-sans font-bold text-blue-500 mt-5 p-4 ">
         ...
         {LSFavouriteData.length ? (
            <div className="favoruiteDataContainer">
               <table className="border-2 border-black w-[80%] rounded-md m-[auto]">
                  <thead>
                     <tr>
                        <th className="border-2 m-2 p-3 border-black rounded-md">
                           Package Name
                        </th>
                        <th className="border-2 m-2 p-3 border-black rounded-lg">
                           Actions
                        </th>
                     </tr>
                  </thead>
                     ...
                     {LSFavouriteData.map((el: Package, ind: number) => {
                        return (
                           <tr className="border-2  border-black " key={ind}>
                              <td className="border-2 font-mono text-lg text-center border-black">
                                 {el.package_name}
                              </td>
            ...
            <div className="emptyContainer border-2 border-black w-[80%] flex m-[auto] h-[400px] justify-center         items-center mt-[80px] flex-col">
               <p className="m-4 p-2 text-lg text-gray-400">
